...
const UpdateForm = ({ props,keyValue, counter ,onCounterChange, userId, token}:any) => {
  ...
  const [formValue, setFormValue] = React.useState<FormValues>(props);
  ...
  console.log(token);
  await api.put(`user/${userId}/workshop/${keyValue}`, formValue , {
    headers:{
